...
#define PT_SCE_DYNLIBDATA   0x61000000 // SCE-specific dynamic linking data
#define PT_SCE_PROC_PARAM   0x61000001 // SCE-specific process parameters
#define PT_SCE_MODULE_PARAM 0x61000002 // SCE-specific module parameters
#define PT_SCE_RELRO        0x61000010 // SCE-specific relro data
#define PT_SCE_COMMENT      0x6FFFFF00 // SCE-specific comment
#define PT_SCE_VERSION      0x6FFFFF01 // SCE-specific version

// PS4 tags
#define DT_SCE_FINGERPRINT       0x61000007
#define DT_SCE_FILENAME          0x61000009
...
#define DT_SCE_STUB_MODULE_VER   0x6100001F
#define DT_SCE_STUB_LIBRARY_NAME 0x61000021
#define DT_SCE_STUB_LIBRARY_VER  0x61000023
...
namespace BinaryNinja
{
    ...
    class PS4View: public BinaryView
    {
        ...
        Elf64ProgramHeader m_sceDynLibData;
        ...
        Elf64SectionHeader m_hashtable;
    ...
    public:
        PS4View(BinaryView* data, bool parseOnly = false);
        ~PS4View();
        std::string ResolveNids(const std::string& input);

        virtual bool Init() override;
    };

    class PS4ViewType: public BinaryViewType
    {
        Ref<Logger> m_logger;
    public:
        PS4ViewType();
